...
<style scoped>
    ...
    .slide_enter_active{animation: .3s slideMove;}
    @keyframes slideMove{
    ...
    .detail_list .detail_list_bg{ width:100%; height:100%; background: url(/images/img.jpg) 0 40%; filter: blur(20px); background-size:cover; position: absolute; left: 0; top: 0;}
